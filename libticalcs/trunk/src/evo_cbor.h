...
TICALCS_TESTABLE void evo_cbor_free(EvoCborValue *value);
TICALCS_TESTABLE int evo_cbor_parse(const uint8_t *data, size_t data_len, size_t *off, EvoCborValue *value);
