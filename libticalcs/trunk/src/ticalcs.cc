...
static CalcFncts const *const calcs[] =
{
	...
	&calc_labpro,
#endif
#ifndef NO_LABPRO_USB
	&calc_labpro_usb,
#endif
#ifndef NO_EASYTEMP_GOTEMP_USB
	&calc_easytemp_gotemp_usb,
#endif
#ifndef NO_EASYLINK_GOLINK_USB
	&calc_easylink_golink_usb,
#endif
#ifndef NO_CBR2_GOMOTION_USB
...
#endif
#ifndef NO_LABPRO_USB
	| (UINT64_C(1) << CALC_LABPRO_USB)
#endif
#ifndef NO_EASYTEMP_GOTEMP_USB
	| (UINT64_C(1) << CALC_EASYTEMP_GOTEMP_USB)
#endif
#ifndef NO_EASYLINK_GOLINK_USB
	| (UINT64_C(1) << CALC_EASYLINK_GOLINK_USB)
#endif
#ifndef NO_CBR2_GOMOTION_USB
	| (UINT64_C(1) << CALC_CBR2_GOMOTION_USB)
#endif
#ifndef NO_GODIRECT_USB
	| (UINT64_C(1) << CALC_GODIRECT_USB)
#endif
#ifndef NO_TI84EVO_USB
...
int ticalcs_default_event_hook(CalcHandle * handle, uint32_t event_count, const CalcEventData * event, void * user_pointer)
{
	...
	switch (event->type)
	{
		...
		case CALC_EVENT_TYPE_UNKNOWN:
		case CALC_EVENT_TYPE_AFTER_SEND_DBUS_PKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_DBUS_PKT_HEADER:
		case CALC_EVENT_TYPE_BEFORE_RECV_DBUS_PKT_DATA:
		case CALC_EVENT_TYPE_AFTER_SEND_DUSB_RPKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_DUSB_RPKT:
		case CALC_EVENT_TYPE_AFTER_SEND_DUSB_VPKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_DUSB_VPKT:
		case CALC_EVENT_TYPE_AFTER_SEND_NSP_RPKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_NSP_RPKT:
		case CALC_EVENT_TYPE_AFTER_SEND_NSP_VPKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_NSP_VPKT:
		case CALC_EVENT_TYPE_AFTER_SEND_ROMDUMP_PKT:
		case CALC_EVENT_TYPE_BEFORE_RECV_ROMDUMP_PKT:
		case CALC_EVENT_TYPE_BEFORE_GENERIC_OPERATION:
		case CALC_EVENT_TYPE_AFTER_GENERIC_OPERATION:
		case CALC_EVENT_TYPE_USER:
		default: break;
	}
	return event->retval;
}
