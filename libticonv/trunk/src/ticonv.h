...
typedef enum 
{
	...
	CALC_TI82AEP_USB, // 36
	CALC_TIPRESENTER, CALC_CBL, CALC_CBR, CALC_CBL2, CALC_CBR2, CALC_LABPRO, // 42
	CALC_LABPRO_USB, CALC_EASYTEMP_GOTEMP_USB, CALC_EASYLINK_GOLINK_USB, CALC_CBR2_GOMOTION_USB, CALC_GODIRECT_USB, // 47
	CALC_TI84EVO_USB, // 48
	CALC_TI84EVOT_USB, // 49
	CALC_TI83EVO_USB, // 50
	CALC_MAX
} CalcModel;
