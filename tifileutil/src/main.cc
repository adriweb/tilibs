 ...
 * Copyright (C) 2019-2025 Lionel Debroux (tifileutil)
 * Copyright (C) 2025      Adrien Bertrand (tifileutil)
 *
...
static int complexify_type(CalcModel model, uint8_t type_id)
{
	...
	// TI-83+/84+/83PCE/84PCE family
	if (type_id == TI83_REAL || type_id == TI83_LIST) {
		return type_id + TI83_CPLX;
	}
	// TI-83 Premium CE / TI-84 Plus CE specific types
